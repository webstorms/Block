...
# Run training with faster control model
...
#os.system(f"bash create_job.sh shd --method=fast_naive --t_len=500 --beta_requires_grad=True --readout_max=False --single_spike=False --dataset=shd --load_spatial_dims=False --use_augmentation=False --epoch=200 --batch=128 --lr=0.0002")
